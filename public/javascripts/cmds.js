...
window.addEventListener('load', () => {
    ...
    if (code != null) {
        ...
        urlencoded.append("pu", localStorage.getItem('pu'));
        ...
        // const address = fetch(`${localStorage.getItem('iu')}/${localStorage.getItem('ti')}/CustomerApi/EXCELWrapperAPI/tokenAPI`, requestOptions)
        ...
        //json data send
        // var myHeaders = new Headers();
        // myHeaders.append("Content-Type", "application/json");//"application/x-www-form-urlencoded"

        // var urlencoded ={
        //     "ti": localStorage.getItem('ti'),
        //     "ci": localStorage.getItem('ci'),
        //     "cs": localStorage.getItem('cs'),
        //     "iu": localStorage.getItem('iu'),
        //     "pu": localStorage.getItem('pu'),
        ...
        const address = fetch(`/accesstoken`, requestOptions)//`https://excel-addin-prd.azurewebsites.net/accesstoken`
            .then(response => response.json())
            .then((result) => {
                return result
            })
        ...
        document.getElementById("signInModalHeading").innerHTML = "Sign In";
        document.getElementById("signInModalText").innerHTML = `Signed in Successfully.`;
        signInModal.show();
